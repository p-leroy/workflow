...
tiles500mC3 = os.path.join(traitements, 'C3/tiles500m')
...
#%% lastile
args = {'i': tiles500mC3 + '/*_g_thin.laz',
        'remove_buffer': None,
        'cores': Ncores,
        'olaz': None}
lastools.exe('lastile', args)
...
#%% lasmerge
args = {'i': tiles500mC3 + '/*_g_thin_1.laz',
