...
c2_root = os.path.join(idir, 'C2_denoised', 'processing', 'C2_thin_lowest_lastOnly_1m')
c2_thin = c2_root + '.laz'
# C3 input
c3_config = 'i_corr_not_classified'  # values are defined in config_workflow
c3_root = os.path.join(idir, 'C3_denoised_i', 'processing', 'C3_thin_lowest_lastOnly_1m')
c3_thin = c3_root + '.laz'
