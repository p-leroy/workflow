...
tiles_in_d = os.path.join(root_, '05-Traitements', 'C2', 'denoised', 'tiles')
tiles_in = os.path.join(tiles_in_d, '*.laz')
tiles_out_d = os.path.join(root_, '05-Traitements', 'C2', 'denoised', 'tiles_thin_lastOnly')
tiles_out = os.path.join(tiles_out_d, '*.laz')
tiles_out_1 = os.path.join(tiles_out_d, '*_1.laz')
o = os.path.join(root_, '05-Traitements', 'C2_thin_lowest_lastOnly_1m.laz')
